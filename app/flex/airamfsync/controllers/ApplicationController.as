package airamfsync.controllers {
  import airamfsync.models.*;
  import airamfsync.commands.*;
  ...
  public class ApplicationController extends RxApplicationController {
    ...
    public static var models:Array = [Address, Business, Location, Person]; /* Models */
